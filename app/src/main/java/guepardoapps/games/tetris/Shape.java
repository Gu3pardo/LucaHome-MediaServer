...
public class Shape {
    ...
    public static Shape t(@NonNull GameSurfaceView display) {
        return new Shape(
                new Coordinates(SQUARE_SIZE, -2 * SQUARE_SIZE),
                new Coordinates(2 * SQUARE_SIZE, -SQUARE_SIZE),
                new Coordinates(SQUARE_SIZE, -SQUARE_SIZE),
                new Coordinates(0, -SQUARE_SIZE),
                Piece.T,
                display);
    }

    public static Shape l(@NonNull GameSurfaceView display) {
        return new Shape(
                new Coordinates(3 * SQUARE_SIZE, -4 * SQUARE_SIZE),
                new Coordinates(3 * SQUARE_SIZE, -3 * SQUARE_SIZE),
                new Coordinates(3 * SQUARE_SIZE, -2 * SQUARE_SIZE),
                new Coordinates(3 * SQUARE_SIZE, -SQUARE_SIZE),
                Piece.L,
                display);
    }

    public static Shape z(@NonNull GameSurfaceView display) {
        return new Shape(
                new Coordinates(0, -2 * SQUARE_SIZE),
                new Coordinates(SQUARE_SIZE, -2 * SQUARE_SIZE),
                new Coordinates(SQUARE_SIZE, -SQUARE_SIZE),
                new Coordinates(2 * SQUARE_SIZE, -SQUARE_SIZE),
                Piece.Z,
    ...
    public static Shape s(@NonNull GameSurfaceView display) {
        return new Shape(
                new Coordinates(4 * SQUARE_SIZE, -2 * SQUARE_SIZE),
                new Coordinates(4 * SQUARE_SIZE, -SQUARE_SIZE),
                new Coordinates(5 * SQUARE_SIZE, -2 * SQUARE_SIZE),
                new Coordinates(5 * SQUARE_SIZE, -SQUARE_SIZE),
                Piece.S,
                display);
    }

    public static Shape ll(@NonNull GameSurfaceView display) {
        return new Shape(
                new Coordinates(0, -3 * SQUARE_SIZE),
                new Coordinates(0, -2 * SQUARE_SIZE),
                new Coordinates(0, -SQUARE_SIZE),
                new Coordinates(SQUARE_SIZE, -SQUARE_SIZE),
                Piece.LL,
    ...
    private Shape(
            @NonNull Coordinates a,
            @NonNull Coordinates b,
            @NonNull Coordinates c,
            @NonNull Coordinates d,
            @NonNull Piece id,
            @NonNull GameSurfaceView gameSurfaceView) {
        CoordinatesA = a;
        CoordinatesB = b;
        CoordinatesC = c;
        CoordinatesD = d;
        ...
        new SmartMirrorLogger(TAG).Debug("Created Shape...");
    }
    ...
    public void Rotate(@NonNull Piece id) {
        switch (id) {
            case T:
            case Z:
            case LL:
    ...
    private int dH() {
        return _gameSurfaceView.DisplayHeight() - 6 * SQUARE_SIZE;
    }

    private int dW() {
        return _gameSurfaceView.DisplayWidth() - 4 * SQUARE_SIZE;
    }
}
